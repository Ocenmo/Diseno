...
const Rutas = () => {
    ...
    return (
        <div className="flex-1 relative">
            ...
            {path.length > 1 && (
            <div className="absolute w-full max-w-[90%] md:max-w-md h-fit bottom-20 md:bottom-40 left-1/2 transform -translate-x-1/2 z-10 flex flex-col items-center justify-center border border-black rounded-[99px] bg-[#14213d] text-white shadow-[0_4px_8px_#081c15] px-4 py-3 overflow-hidden text-wrap break-words">
                <input
